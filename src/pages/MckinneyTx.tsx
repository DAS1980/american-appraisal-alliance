...
/**
 * Placeholder service-area page for McKinney, TX. Minimal stub so "McKinney"
 * in the Service Areas nav dropdown has a working destination; full content
 * to be designed separately.
 */
const MckinneyTx = React.forwardRef<HTMLDivElement>((props, ref) => {
  return (
    <PageLayout currentPage="mckinney-tx">
      <div ref={ref}>
        <Header />
        <main className="container max-w-3xl mx-auto px-4 py-24 text-center">
          <h1 className="font-['Playfair_Display',serif] text-3xl md:text-4xl font-bold text-[hsl(218_60%_20%)] mb-4">
            McKinney, TX Real Estate Appraisals
          </h1>
          <p className="text-muted-foreground leading-relaxed">
            USPAP-compliant appraisal services for McKinney, Texas are coming soon to this page.
...
MckinneyTx.displayName = "MckinneyTx";

export default MckinneyTx;
